...
MONGODB_CONNECTION = 'mongodb+srv://test:sparta@cluster0.e0lack1.mongodb.net/?retryWrites=true&w=majority'
...
def update_profile():
    ...
    try:
        ...
        if 'file_give' in request.files:
            file = request.files.get('file-five')
            filename = secure_filename(file.filename)
            extension = filename.split('.')[-1]
            file_path = f'profile-pics/{username}{extension}'
